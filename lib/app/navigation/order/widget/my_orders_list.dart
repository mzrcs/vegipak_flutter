            ...
            : ListView.builder(
                ...
                itemBuilder: (_, index) {
                  return Card(
                                    ...
                                    Column(
                                      ...
                                      children: List.generate(
                                        ...
                                        value.myOrdersList[index].cartItems!
                                            .length,
                                        (i) {
                                          var cart = value.myOrdersList[index]
                                              .cartItems![i];
                                          return Padding(
                                            padding: const EdgeInsets.symmetric(
                                                vertical: 5.0),
                    ...
                    //         ),
                    //         child: Text(
                    //           value.myOrdersList[index].status.toUpperCase(),
                    //           style: TextStyle(
                    //             fontSize: 10.sp,
                    //           ),
                    //         ),
                    ...
                    //     children: List.generate(
                    //       // growable: false,
                    //       value.myOrdersList[index].cartItems!.length,
                    //       (i) {
                    //         var cart = value.myOrdersList[index].cartItems![i];
                    //         return Padding(
