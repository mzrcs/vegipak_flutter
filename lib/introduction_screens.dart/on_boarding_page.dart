    ...
    return IntroductionScreen(
      ...
      globalHeader: Align(
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: _buildImage('app_logo/vegipak-black-border-carrot.png', 80),
          ),
        ),
      ),
      ...
      pages: [
        PageViewModel(
          ...
          image: _buildImage('scooter_guy.jpeg', 250),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Fresh Vegitables",
          body: "We don't hoarding so you can enjoy the freshness of nature.",
          ...
          image: _buildImage('fresh_vegi.jpg'),
          reverse: true,
        ),
        PageViewModel(
          ...
          image: _buildImage('delivery-24h.jpg'),
          decoration: pageDecoration,
        ),
      ],
