...
class _EditPasswordState extends State<EditPassword> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              obscureText: true,
              controller: this._newPasswordTextController,
              maxLines: 1,
              onSubmitted: (value) => this._submitButtonClick(),
            ),
            (this._newPasswordError.isNotEmpty)
                ? Padding(
            ...
            (this._confirmPasswordError.isNotEmpty)
                ? Padding(
                    padding: EdgeInsets.only(top: 8),
                    child: Text(
            ...
            TextField(
              ...
              cursorColor: Constants.COLOR_CURSOR,
              obscureText: true,
              controller: this._actualPasswordTextController,
              maxLines: 1,
              onSubmitted: (value) => this._submitButtonClick(),
            ),
            ...
            (this._errorSendingRequest.isNotEmpty)
                ? Padding(
  ...
  void _submitForm() async {
    ...
    var trimmedConfirmPassword =
        this._confirmPasswordTextController.text;
    ...
    try {
      ...
      if (response.statusCode != 200) {
        setState(() {
            this._errorSendingRequest = 'Ha ocurrido un error inesperado, por favor, intente nuevamente';
